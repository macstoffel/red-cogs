...
def svg_bar_chart(title, data_pairs, width=700, height=260, margin=120, rotate_labels=False):
    ...
    for i, (lab, val) in enumerate(data_pairs):
        ...
        svg.append(f'<text x="{margin-6}" y="{y+bar_height/2}" text-anchor="start" dominant-baseline="middle" font-size="12">{html.escape(str(lab))}</text>')
